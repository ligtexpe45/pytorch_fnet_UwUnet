...
class BufferedPatchDataset(FnetDataset):
    ...
    def get_random_patch(self):
        ...
        # Ensure that the patch doesn't go out of bounds
        start_0 = np.random.randint(0, max(1, spec_channels - patch_size))
        start_1 = np.random.randint(0, max(1, spec_channels - patch_size))
        ...
        if final_channels == 1:
            index.pop(0)
            patch.append(datum[1][tuple(index)])
